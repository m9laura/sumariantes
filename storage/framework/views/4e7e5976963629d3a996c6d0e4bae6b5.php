...
<div class="card" style="position: relative; color: white;">
    <div style="background-image: url('<?php echo e(asset('storage/imagenes/gamea_logo.png')); ?>'); 
    ...
    <div class="card-body" style="position: relative; font-family: 'Times New Roman', Times, serif; background: rgba(0, 0, 0, 0.5);">
        <div class="row">
            <div class="col-md-12 text-center">
                <strong>
                    <?php if(auth()->user()->genero == 1): ?>
                        <h1 style="text-transform: uppercase; font-weight: bold;">Bienvenido señor <?php echo e(auth()->user()->name); ?> <?php echo e(auth()->user()->apellidopaterno); ?></h1>
                    <?php else: ?>
                        <h1 style="text-transform: uppercase; font-weight: bold;">Bienvenida señorita <?php echo e(auth()->user()->name); ?> <?php echo e(auth()->user()->apellidopaterno); ?></h1>
                    <?php endif; ?>
                </strong>
            </div>

            <div class="col-md-3 text-center">
                <img src="<?php echo e(Storage::url(auth()->user()->foto)); ?>" alt="Foto de usuario" class="img-fluid rounded">
                <br><br>
            ...
            <div class="col-md-6">
                <ul>
                    ...
                    <li><b>Nombre:</b> <?php echo e(ucfirst(auth()->user()->name)); ?></li>
                    <li><b>Apellido paterno:</b> <?php echo e(ucfirst(auth()->user()->apellidopaterno)); ?></li>
                    <li><b>Apellido materno:</b> <?php echo e(ucfirst(auth()->user()->apellidomaterno)); ?></li>
                    <li><b>Documento de identidad:</b> <?php echo e(auth()->user()->ci); ?> <?php echo e(auth()->user()->expedito); ?></li>
                    <li><b>Estado laboral:</b> <?php echo e(auth()->user()->estado == 1 ? 'Trabajando' : 'No trabajado'); ?></li>
                    <li><b>Género:</b> <?php echo e(auth()->user()->genero == 1 ? 'Masculino' : 'Femenino'); ?></li>
                    <li><b>Unidad:</b> <?php echo e(ucfirst(auth()->user()->unidad)); ?></li>
                    <li><b>Cargo:</b> <?php echo e(ucfirst(auth()->user()->cargo)); ?></li>
                    <li class="mt-0">
                        <b>Role:</b>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(ucfirst(auth()->user()->roles->first()->name)); ?>

                    </li>
                    <li><b>Fecha de nacimiento:</b> <?php echo e(auth()->user()->fnacimiento); ?></li>
                    <li><b>Fecha de inicio:</b> <?php echo e(auth()->user()->finicio); ?></li>
                    <?php if(auth()->user()->estado == 0): ?>
                        <li><b>Fecha de suspensión:</b> <?php echo e(auth()->user()->fsuspension); ?></li>
                    <?php endif; ?>
                </ul>
            </div>
            ...
            <div class="col-md-3 text-center">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.index')): ?>
                    <a class="btn btn-outline-danger btn-sm btn-block" href="<?php echo e(route('roles.index')); ?>"><i class="fas fa-eye"></i> Listar Roles</a>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.index')): ?>
                    <a class="btn btn-outline-warning btn-sm btn-block" href="<?php echo e(route('admin.users.index')); ?>"><i class="fas fa-eye"></i> Listar Usuarios</a>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('personas.index')): ?>
                    <a class="btn btn-outline-info btn-sm btn-block" href="<?php echo e(route('personas.index')); ?>"><i class="fas fa-eye"></i> Listar Personas</a>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tipo_personas.index')): ?>
                    <a class="btn btn-outline-primary btn-sm btn-block" href="<?php echo e(route('tipo_personas.index')); ?>"><i class="fas fa-eye"></i> Listar Tipos Personas</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="cambiarContrasenaForm" action="<?php echo e(route('homes.update', ['home' => auth()->user()->id])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SGCCSV4\resources\views/home.blade.php ENDPATH**/ ?>