...
@section('title', 'LISTADO DE SUMARIADOS')
    ...
    <div class="card-body" style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-12 col-md-3 my-1">
                <a href="{{ route('personas.imprimirTodossumarios') }}" class="btn btn-danger btn-block btn-sm">
                    <i class="fas fa-file-pdf"></i> Imprimir Todos
                </a>
            </div>
            <div class="col-12 col-md-3 my-1">
                <a href="{{ route('personas.exportarsumarios') }}" class="btn btn-primary btn-block btn-sm">
                    <i class="fas fa-file-excel"></i> Exportar a Excel
                </a>
            </div>
            <div class="col-12 col-md-3 my-1">
                <a class="btn btn-success btn-block btn-sm" href="{{ route('personas.create') }}">
...
@stop
@section('content')
    <h1 style="font-family: 'Times New Roman', Times, serif;">{{ ucfirst('Sumariados') }}</h1>
    <div class="card container-fluid">
        <div class="card-body">
                ...
                <table id="tabla-personas" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th>Ci</th>
                            <th>Institución</th>
                            @canany(['personas.show', 'personas.edit', 'personas.destroy', 'personas.pdf'])
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            <form action="{{ route('personas.destroy', ':id') }}" method="POST" class="form-eliminar">
                                ...
                                @endcan
                                @can('personas.pdf')
                                <a href="{{ route('personas.pdf', ':id') }}" class="btn btn-info btn-sm">
                                    <i class="fas fa-file-pdf"></i>
                                </a>
                                @endcan
                                <a href="{{ route('personas.imprimirPorIds', ':id') }}" class="btn btn-warning btn-sm">
