                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <select class="form-control" name="gravedad">
                        <option value="1" @if (old('gravedad') == '1') selected @endif>ECONOMICO
                        </option>
                        <option value="2" @if (old('gravedad') == '2') selected @endif>DIAS DE INPEDIMENTO
                        </option>
                        <option value="3" @if (old('gravedad') == '3') selected @endif>DESTITUCION
                        </option>
